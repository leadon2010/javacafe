...
function createContentFunc(pno) {
	...
	let p_1 = $('<p />').addClass("card-text").html(pno.content);
	...
	div1.append(div2.append(a1.append(img1), div3.append(h_4.append(a2), h_5, p_1), div4.append(small_1)));
